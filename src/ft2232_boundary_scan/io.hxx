...
public:
    ...
    /// Getter of Io's ID @return ID of the Io
    int getId();

    /// Getter of Io's state @return State of the Io
    int getState();

    /// Getter of Io's state @return State of the Io
    void setState(int state);

    /// Getter of Io's saved state @return Saved State of the Io
    int getSavedState();

    /// Setter of Io's saved state @return State of the Io
    void setSavedState(int savedState);

    /// Getter of Io's name (ex. IO_M5) @return Name of the Io
    std::string getName();

    /// Getter of Io's direction @return Direction of the Io
    std::string getDirection();

    /// Setter of Io's direction @return Direction of the Io
    void setDirection(std::string direction);

    /// Getter of read state of input Io @return Read state of the Io
    int getRead();

    /// Prints the members of an Io
    void printPin();

    /// Setter of read state of input Io @param val : Read state of the Io
